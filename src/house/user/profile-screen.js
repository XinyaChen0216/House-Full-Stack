    ...
    <div>
      ...
      {profile && (
        <>
          <div>
            <div>
              <label for="firstname" className="fs-5">
                First Name
              </label>
              <input
                type="text"
            ...
            <div>
              <label for="lastname" className="fs-5">
                Last Name
              </label>
              <input
                type="text"
            ...
            <div>
              <label for="phone" className="fs-5">
                Phone Number
              </label>
              <input
                type="text"
            ...
            <div>
              <label for="email" className="fs-5 col">
                Email
              </label>
              <input
                className="form-control"
            ...
            <div>
              ...
              <span className="text-primary font-italic form-control bg-light-grey">
                {" " + profile.role}
              </span>
            </div>
          ...
          <span> </span>
          <button onClick={save} className="btn btn-primary mt-2">
            Save{" "}
          </button>
        </>
      )}
